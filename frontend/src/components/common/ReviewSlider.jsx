...
function ReviewSlider() {
  ...
  // Conditionally enable loop if enough reviews are available
    ...
    <div className="text-white">
      <div className="my-[50px] h-[184px] max-w-maxContentTab lg:max-w-maxContent">
        <Swiper
          ...
          spaceBetween={25}
          loop={shouldLoop}  // Enable loop only if enough slides are present
          freeMode={true}
          autoplay={{
            delay: 2500,
            ...
            <SwiperSlide key={i}>
              <div className="flex flex-col gap-3 bg-richblack-800 p-3 text-[14px] text-richblack-25 min-h-[180px] max-h-[180px] glass-bg">
                ...
                <div className="flex items-center gap-2 ">
                  ...
                  <ReactStars
                    count={5}
                    value={Number(review.rating)}  // Ensure rating is treated as a number
                    size={20}
                    edit={false}
                    activeColor="#ffd700"
                    emptyIcon={<FaStar />}
